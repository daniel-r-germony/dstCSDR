...
01. DATA ITEM NUMBER.............: `r params$FlexFile_CDRL_numb`  
...
Block 04: The `r prime_vs_sub` shall develop, maintain, and deliver the data item in accordance with `r FlexFile_CDRL_did`, the CSDR Manual (DoD 5000.04-M-1), and as tailored in this CDRL and Attachment `r params$CSDR_Plan_attch_numb` - CSDR Plan. The CSDR Manual is available from the CADE website at https://cade.osd.mil/.  
...
Block 10, 11, 12, and 13: The `r prime_vs_sub` shall submit reports at frequencies specified in Attachment `r params$CSDR_Plan_attch_numb` - CSDR Plan.  
