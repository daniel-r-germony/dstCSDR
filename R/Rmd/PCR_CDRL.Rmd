---
title: "Progress Curve Report CDRL"
output:
...
01. DATA ITEM NUMBER.............: `r params$PCR_CDRL_numb`  
02. TITLE OF DATA ITEM...........: `r params$PCR_CDRL_title`  
03. SUBTITLE ....................: `r params$PCR_CDRL_subtitle`  
04. AUTHORITY....................: `r params$PCR_CDRL_did`(T) and see Block 16. 
...
09. DIST. STATEMENT REQUIRED.....: `r params$PCR_CDRL_dist`  
...
Block 04: The `r prime_vs_sub` shall develop, maintain, and deliver the data item in accordance with `r PCR_CDRL_did`, the CSDR Manual (DoD 5000.04-M-1), and as tailored in this CDRL and Attachment `r params$CSDR_Plan_attch_numb` - CSDR Plan. The CSDR Manual is available from the CADE website at https://cade.osd.mil/.  
