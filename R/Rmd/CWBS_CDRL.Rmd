---
title: "Contract Work Breakdown Structure and Dictionary CDRL"
output:
...
01. DATA ITEM NUMBER.............: `r params$CWBS_CDRL_numb`  
02. TITLE OF DATA ITEM...........: `r CWBS_CDRL_title`  
03. SUBTITLE ....................: `r CWBS_CDRL_subtitle`  
04. AUTHORITY....................: `r CWBS_CDRL_did`(T) see Block 16.  
...
09. DIST. STATEMENT REQUIRED.....: `r CWBS_CDRL_dist`  
...
Block 04: The `r prime_vs_sub` shall develop, maintain, and deliver the data item in accordance with `r CWBS_CDRL_did`, `r params$CSDR_Plan_std`, the CSDR Manual (DoD 5000.04-M-1), and as tailored in this CDRL and Attachment `r params$CSDR_Plan_attch_numb` - CSDR Plan. The CSDR Manual is available from the CADE website at https://cade.osd.mil/.  

Formats: In addition to the file formats listed in the DID, the contract may develop and submit a stand-alone Microsoft Excel file (extension ".xlsx").  

See Block 15 (REMARKS) in Attachment `r params$CSDR_Plan_attch_numb` - CSDR Plan for additional tailoring and description of the information that shall be provided by the `r prime_vs_sub` in this CDRL's deliverable.  
