...
01. DATA ITEM NUMBER.............: `r params$RDT_CDRL_numb`  
...
Block 04: The `r prime_vs_sub` shall develop, maintain, and deliver the data item in accordance with `r RDT_CDRL_did`, Attachment `r params$RDT_attach_numb` - RDT, and as tailored in this CDRL and Attachment `r params$CSDR_Plan_attch_numb` - CSDR Plan.  
