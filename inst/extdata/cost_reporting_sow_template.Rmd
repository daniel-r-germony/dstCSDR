...
```{r prime-or-sub, echo=FALSE}
prime_vs_sub <- if (params$CSDR_Plan_type == "Contract") {"Contractor"} else {"Subcontractor"}
```

```{r CDRL-Titles, echo=FALSE}
# Block 2: CDRL Titles ########################################################
...
```{r CDRL-DID-Numbers, echo=FALSE}
# Block 4: CDRL DID Numbers ###################################################
CWBS_CDRL_did     <- "DI-MGMT-81334D"
RDT_CDRL_did      <- stringr::str_c("See Attachment ", params$RDT_attach_numb)
...
LSPD_CDRL_did     <- stringr::str_c("See Attachment ", params$LSPD_attach_numb)
AUMC_CDRL_did     <- "DI-MGMT-81334D(T)"
BOM_CDRL_did      <- "DI-MGMT-81994"
meeting_docs_CDRL_did <- "DI-MGMT-81605"
```

```{r CDRL-Distros, echo=FALSE}
