...
01. DATA ITEM NUMBER.............: `r params_from_excel$CWBS_CDRL_numb`  
...
Block 04: The `r prime_vs_sub` shall develop, maintain, and deliver the data item in accordance with `r CWBS_CDRL_did`, `r params_from_excel$CSDR_Plan_std`, the CSDR Manual (DoD 5000.04-M-1), and as tailored in this CDRL and Attachment `r params_from_excel$CSDR_plan_attch_numb` - CSDR Plan. The CSDR Manual is available from the CADE website at https://cade.osd.mil/.  
...
See Block 15 (REMARKS) in Attachment `r params_from_excel$CSDR_plan_attch_numb` - CSDR Plan for additional tailoring and description of the information that shall be provided by the `r prime_vs_sub` in this CDRL's deliverable.  
