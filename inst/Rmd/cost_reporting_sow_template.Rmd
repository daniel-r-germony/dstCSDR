...
params:
  ...
  QtyData_CDRL_lgl:
    choices:
      ...
      - FALSE
    input: select
    label: "Quantity Data Report (DD Form 1921-Q) CDRL Required"
    value: TRUE
  MR_CDRL_lgl:
    choices:
      - TRUE
      - FALSE
    input: select
    label: "Maintenance and Repair Report (DD Form 1921-M/R) CDRL Required"
    value: TRUE
  TDR_CDRL_lgl:
    choices:
      - TRUE
      - FALSE
    input: select
    label: "Technical Data Report (DD Form 1921-T) CDRL Required"
    value: TRUE
  CWBS_CDRL_lgl:
    choices:
      - TRUE
  ...
  QtyData_CDRL_numb:
    input: text
    label: "Quantity Data Report (DD Form 1921-Q) CDRL Number"
