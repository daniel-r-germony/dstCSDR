...
`{dstCSDR}` includes a few functions that transform the CSDR data from its origional format into a tidy table and can combine the reported cost data with the metadata, making it easier to work with multiple submissions at once.
